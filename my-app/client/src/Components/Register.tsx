...
export const  FormikFormDemo= ()=>  {
    ...
    const isFormFieldValid = (name:string) => !!((formik.touched as any)[name] && (formik.touched as any)[name]);
    const getFormErrorMessage = (name:string) => {
        return isFormFieldValid(name) && <h5 className="p-error">{(formik.touched as any)}</h5>;
    };
